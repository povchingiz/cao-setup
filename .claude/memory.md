...
- [2026-09-23] `2_configure/cao.config.local.toml` overrides the tracked `cao.config.toml` and is gitignored. Editing only the tracked file changes nothing at runtime - edit both, then run `./3_apply/apply.sh`.
